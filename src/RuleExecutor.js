...
export const programEnocunter = async (text) => {
    ...
    const decisionsMap = await validateDecisions(ruleDecisions, "38a778be-991f-40f0-9837-7244836ecdfc", "35253eab-6594-4bad-9243-ca6ef15fc054");
    // console.log(decisionsMap);
